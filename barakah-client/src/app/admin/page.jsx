    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/admin/products" className="btn border border-[#d4af37] text-[#d4af37] hover:bg-[#0f2a44] hover:border-[#0f2a44] transition">
            View Products
          </Link>

          <Link href="/admin/products/add" className="btn border border-[#d4af37] text-[#d4af37] hover:bg-[#0f2a44] hover:border-[#0f2a44] transition">
            Add Product
          </Link>

          <Link href="/admin/orders" className="btn border border-[#d4af37] text-[#d4af37] hover:bg-[#0f2a44] hover:border-[#0f2a44] transition">
            View Orders
          </Link>
        </div>
      </div>
